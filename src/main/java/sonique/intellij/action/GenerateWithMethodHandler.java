...
public class GenerateWithMethodHandler extends GenerateSetterHandler {
    ...
    private final WithMethodNameGenerator withMethodNameGenerator;

    public GenerateWithMethodHandler(WithMethodNameGenerator withMethodNameGenerator) {
        this.withMethodNameGenerator = withMethodNameGenerator;
    }
    ...
    private PsiMethod generateMethodPrototype(PsiField field) {
        ...
        String methodName = withMethodNameGenerator.generateMethodNameFor(propertyName);
